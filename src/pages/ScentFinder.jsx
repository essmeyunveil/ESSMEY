    ...
    options: [
      {
        id: "floral",
        label: "Floral & Sweet",
        description: "Jasmine, Rose, Vanilla",
        icon: "🌺",
      },
      {
        id: "fresh",
        label: "Fresh & Citrus",
        description: "Lemon, Ocean, Mint",
        icon: "🍋",
      },
      {
        id: "woody",
        label: "Woody & Earthy",
        description: "Cedar, Sandalwood, Pine",
        icon: "🌲",
      },
      {
        id: "spicy",
        label: "Dark & Spicy",
        description: "Oud, Amber, Black Pepper",
        icon: "🌶️",
      },
    ],
  },
    ...
    options: [
      {
        id: "everyday",
        label: "Everyday & Work",
        description: "Subtle and approachable",
        icon: "☀️",
      },
      {
        id: "evening",
      ...
      },
      {
        ...
        description: "Invigorating and crisp",
        icon: "🏃",
      },
    ],
  },
  ...
  const computeResults = (finalAnswers) => {
    ...
    setTimeout(() => {
      ...
      setRecommendedProducts(
        scoredProducts.slice(0, 3).map((sp) => sp.product)
      );
  ...
  const renderComputing = () => (
    ...
    >
      ...
      <p className="text-neutral-600">
        We are analyzing your preferences against our curated collection.
      </p>
    </motion.div>
  );
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
          Based on your preferences, we've selected these exquisite fragrances
          to complement your unique essence.
        </p>
      </div>
      ...
      {recommendedProducts.length > 0 ? (
        ...
        <div className="text-center py-10">
          <p className="mb-6">
            Sorry, we couldn't find an exact match. Please try selecting
            different options or browse our full collection.
          </p>
        </div>
      )}
